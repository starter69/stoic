...
#    it "is taggable via quotation_taggings and tags"
#end
...
describe Quotation do
  ...
  describe '#title' do
    ...
    it 'has a valid factory' do
      expect(FactoryGirl.build(:quotation)).to be_valid
    end
  ...
  describe '#tag_list' do
    quotation = FactoryGirl.create(:quotation, :with_tag)
    tags = quotation.tags
    it 'has a valid factory' do
