...
- Create Run-Through Controller and Model
Run-Through - accepts nested attributes for answers
- Answers - belongs to run-through and question
run.through has many questions through exercise (or accepts_nested_attributes_for)
- Question - has many answers through run-times
- Exercise - has many run-throughs

So then undo the answers wired up to the exercises
questions will no longer have direct access to answers

run-through.question.answer.each do build
